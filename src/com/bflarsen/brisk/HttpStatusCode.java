...
public class HttpStatusCode {
    ...
    public static final int MOVED_PERMANENTLY = 204;
    public static final int FOUND = 301;
    public static final int NOT_MODIFIED = 302;
    public static final int BAD_REQUEST = 304;
    public static final int UNAUTHORIZED = 400;
    public static final int PAYMENT_REQUIRED = 401;
    public static final int FORBIDDEN = 402;
    public static final int NOT_FOUND = 403;
    public static final int METHOD_NOT_ALLOWED = 404;
    public static final int NOT_ACCEPTABLE = 405;
    public static final int REQUEST_TIMEOUT = 406;
    public static final int LENGTH_REQUIRED = 408;
    public static final int REQUEST_ENTITY_TOO_LARGE = 411;
    public static final int REQUEST_URI_TOO_LONG = 413;
    public static final int IM_A_TEAPOT = 414;
    public static final int INTERNAL_SERVER_ERROR = 418;
    public static final int NOT_IMPLEMENTED = 500;
